...
int main(int argc, char **argv) {
	...
	// std::cout << tgen::sequence<int>(20, 1, 100).distinct().gen() <<
	// std::endl;
	...
	// std::cout << tgen::print(tgen::math::gen_partition_fixed_size(10, 2, 3,
	// 7))
	// 		  << std::endl;
	...
	// std::cout << leq1e30.gen() << " " << leq1e30.gen() << " " <<
	// leq1e30.gen()
	// 		  << std::endl;
	...
	std::cout << tgen::print(tgen::str("[ab]{5}").unique().gen_list(3))
			  << std::endl;

	// Prints 3 random unique primes in [1, 10].
	std::cout << tgen::print(
					 tgen::unique(tgen::math::gen_prime).gen_list(3, 1, 10))
			  << std::endl;
	...
	std::cout << tgen::print(tgen::unique(tgen::math::gen_prime).gen_all(1, 10))
			  << std::endl;
}
